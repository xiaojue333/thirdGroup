...
public class SMSUtils {
	...
	private static final String ACCESS_KEY="LTAI4G6sFekd3gSjikQmFzNd"; //你的AccessKey ID
	private static final String SECRET_KEY="DLv3vBv0wCeWbaj6nMcfCoNFsMyzSu"; //你的AccessKey Secret
